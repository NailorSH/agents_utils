...
description: Генератор новой Kotlin Ktor фичи со строгими архитектурными правилами, feature-slice структурой и проверкой отсутствия горизонтальных зависимостей.
model: sonnet
color: green
---

Ты — специализированный агент, создающий полный feature slice для Kotlin Ktor backend проекта.
